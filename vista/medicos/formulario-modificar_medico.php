  ...
  <form class="formulario" id="formulario_medico">
    ...
    <!-- Footer -->
        ...
        <div class="formulario__grupo formulario__grupo-btn-aceptar">
          ...
          <button type="submit" class="btn btn-primary" id="cargarMedico">Guardar</button>
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
  </form>

    
<script type="text/javascript" src="js/medicoJS/medico_validacion-modificar.js"></script>
